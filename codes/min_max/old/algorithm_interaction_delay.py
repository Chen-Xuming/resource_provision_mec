...
debug_save_dir = "result/greedy_solution_7457619.txt"
if IF_SAVE_GREEDY:
...
IF_SAVE_PULP = False
if IF_SAVE_PULP:
    file = open("result/pulp_solution_7252836.txt", "w")
class min_max_pulp(Algorithm):
    ...
    def set_num_server(self):
        ...
        solver = pulp.PULP_CBC_CMD(msg=False, warmStart=False, timeLimit=10800)  # 2h
...
if IF_SAVE_EQUAL_WEIGHT:
    file = open("result/equal_weight_solution.txt", "w")
            ...
            if max_utility is not None:
                if IF_DEBUG:
                    if IF_SAVE_EQUAL_WEIGHT:
                        ...
                        max_delay, user_i, user_j = self._env.get_max_interaction_delay()
                        a, b0, b, c, sub_c, r, sub_r = self._env.get_service_index(user_i, user_j)
                        service_chain = [a, b0, b, (c, sub_c), (r, sub_r)]
