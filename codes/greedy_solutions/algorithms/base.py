from codes.greedy_solutions.env.edge_node import EdgeNode
from codes.greedy_solutions.env.service import Service
from codes.greedy_solutions.env.user import User
...
class BaseAlgorithm:
    ...
    def compute_final_cost(self):
        ...
        self.final_cost = self.env.compute_cost()
        if self.debug:
