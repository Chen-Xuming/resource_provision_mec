...
class Environment:
    ...
    def compute_cost(self, assigned_user_list: list):
        ...
        #
        #         # 传输开销，四段： u_from --> a --> b --> r --> u_to
        #         transmission_cost += self.t_price_user_node[user_from.user_id][user_from.service_A.node_id] * self.data_size_ua
        #         transmission_cost += self.t_price_node_node[user_from.service_A.node_id][self.service_b.node_id] * self.data_size_ab
        #         transmission_cost += self.t_price_node_node[self.service_b.node_id][user_to.service_R.node_id] * self.data_size_br
        #         transmission_cost += self.t_price_user_node[user_to.user_id][user_to.service_R.node_id] * self.data_size_ru
