...
data_file = "./result/{}_seed{}_node{}_user{}.json".format(prefix, seed, node_num, user_num)
save_file = "./result/{}_seed{}_node{}_user{}.svg".format(prefix, seed, node_num, user_num)
